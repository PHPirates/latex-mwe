...
% bibliography
\usepackage[
    hyperref=true,        % hyperref uses links
    backref=true,         % goes back to citations
    backend=biber,        % use biber as backend
    % maxbibnames=9,      % with 9 names at most in bibliography
    maxcitenames=2,       % and 2 in citations
    style=authoryear,     % bibstyle
    citestyle=authoryear, % citystyle
    sorting=none          % and sorting in citation order
]{biblatex} % hyperref uses links, backref goes back to citations, uses biber as backend, with 9 names at most in bibliography and 2 in citations, citing using numbers, and sorting in citation order
